...
Image::Release(void)
{
    ...
    if(mVkImage != VK_NULL_HANDLE) {
        vk_DestroyImage(mVkContext->vkDevice, mVkImage, NULL);
...
Image::Create()
{
    ...
    VkResult err = vk_CreateImage(mVkContext->vkDevice, &info, NULL, &mVkImage);
    assert(!err);
...
Image::CopyBufferToImage(VkCommandBuffer *activeCmdBuffer, VkBuffer srcBuffer)
{
    ...
    vk_CmdCopyBufferToImage(*activeCmdBuffer, srcBuffer, mVkImage, mVkImageLayout, 1, &mVkBufferImageCopy);
}
...
Image::CopyImageToBuffer(VkCommandBuffer *activeCmdBuffer, VkBuffer srcBuffer)
{
    ...
    vk_CmdCopyImageToBuffer(*activeCmdBuffer, mVkImage, mVkImageLayout, srcBuffer, 1, &mVkBufferImageCopy);
}
...
Image::BlitImage(VkCommandBuffer *activeCmdBuffer, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, const VkImageBlit* imageBlit, VkFilter imageFilter)
{
    ...
    vk_CmdBlitImage(*activeCmdBuffer, GetImage(), srcImageLayout, dstImage, dstImageLayout, 1, imageBlit, imageFilter);
}
...
Image::ModifyImageLayout(VkCommandBuffer *activeCmdBuffer, VkImageLayout newImageLayout)
{
    ...
    vk_CmdPipelineBarrier(*activeCmdBuffer, srcStages, destStages, 0, 0, NULL, 0, NULL, 1, &imageMemoryBarrier);
