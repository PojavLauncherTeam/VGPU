...
#include "context_t/ggl_context.h"
...
struct array_t {
    typedef void (*fetcher_t)(gles_context_t*, GLfixed*, const GLvoid*);
    fetcher_t       fetch;
...
struct array_machine_t {
    ...
    void (*compileElements)(gles_context_t*, vertex_t*, GLint, GLsizei);
    void (*compileElement)(gles_context_t*, vertex_t*, GLint);
    ...
    void (*perspective)(gles_context_t*c, vertex_t* v);
    void (*clipVertex)(gles_context_t* c, vertex_t* nv,
            GGLfixed t, const vertex_t* s, const vertex_t* p);
    void (*clipEye)(gles_context_t* c, vertex_t* nv,
            GGLfixed t, const vertex_t* s, const vertex_t* p);
};
...
struct fog_t {
    ...
    GLenum      mode;
    GLfixed     (*fog)(gles_context_t* c, GLfixed z);
};
...
struct lighting_t {
    ...
    GLboolean           enable;
    GLenum              shadeModel;
    typedef void (*light_fct_t)(gles_context_t*, vertex_t*);
    void (*lightVertex)(gles_context_t* c, vertex_t* v);
    void (*lightTriangle)(gles_context_t* c,
